...
const GitHubIcon: React.FC = () => (
  <svg width="28" height="28" viewBox="71 71 370 370" aria-label="GitHub" role="img">
...
const LinkedInIcon: React.FC = () => (
  <svg width="28" height="28" viewBox="0 0 512 512" aria-label="LinkedIn" role="img">
    <path d="M186.4 142.4c0 19-15.3 34.5-34.2 34.5 -18.9 0-34.2-15.4-34.2-34.5 0-19 15.3-34.5 34.2-34.5C171.1 107.9 186.4 123.4 186.4 142.4zM181.4 201.3h-57.8V388.1h57.8V201.3zM273.8 201.3h-55.4V388.1h55.4c0 0 0-69.3 0-98 0-26.3 12.1-41.9 35.2-41.9 21.3 0 31.5 15 31.5 41.9 0 26.9 0 98 0 98h57.5c0 0 0-68.2 0-118.3 0-50-28.3-74.2-68-74.2 -39.6 0-56.3 30.9-56.3 30.9v-25.2H273.8z"/>
  </svg>
);

const QrIcon: React.FC = () => (
  <svg width="28" height="28" viewBox="0 0 192 192" aria-label="QR" role="img" xmlns="http://www.w3.org/2000/svg" fill="none">
...
const ShareIcon: React.FC = () => (
  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Share" role="img">
...
const MinimalSocialIcons: React.FC<SocialIconsProps> = ({
  ...
  const handleShare = async () => {
    try {
      if ((navigator as any).share) {
        await (navigator as any).share({ title: shareTitleText, text: shareTextText, url: shareLink });
        return;
      }
    } catch {}
    try {
  ...
  return (
    <div className="minimal-social-icons" style={{ display: 'inline-flex', gap: '10px', justifyContent: 'center' }}>
      <a href={githubUrl} target="_blank" rel="noopener noreferrer" aria-label="GitHub" style={{ padding: 0 }}>
        <GitHubIcon />
      </a>
      <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{ padding: 0 }}>
        <LinkedInIcon />
      </a>
      <button
      ...
      {showQr && (
        ...
        >
          <div
            ...
            style={{ background: '#fff', borderRadius: 12, padding: 16, width: 240, boxShadow: '0 10px 30px rgba(0,0,0,0.2)', textAlign: 'center' }}
          >
...
export default MinimalSocialIcons;
